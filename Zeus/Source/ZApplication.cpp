...
void ZApplication::Update()
{
    ...
    z_Cube2 = z_MainLevel.Create3DMeshEntity(ZTransform(Vec3(-7.5,0,0), Vec3(45, 0, 0)), ZCube(), ZShader("Zeus/Resource/Shaders/Lighting/ADS.vert", "Zeus/Resource/Shaders/Lighting/ADS.frag", { .Red = 1.0, .Green = 1.0, .Blue = 0.0 }));
    ...
    z_Ship = z_MainLevel.Create3DMeshEntity(ZTransform(Vec3(5.0, 2, 0), Vec3(1.0)), ZModel("Zeus/Resource/Models/SpaceShip", "scene.gltf"), ZShader("Zeus/Resource/Shaders/Lighting/AssimpEADS.vert", "Zeus/Resource/Shaders/Lighting/AssimpEADS.frag"));
